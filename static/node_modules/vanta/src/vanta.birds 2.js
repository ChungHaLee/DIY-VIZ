...
import { pitchInfo } from '../../../../static/src/js/circle.js'
  ...
  onInit() {
    ...
    if (!GPGPU) {
      ...
      for (var i = 0; i < numBirds; i++) {
        ...
        // console.log(newBirdGeo.attributes.position)
  ...
  onUpdate() {
    ...
    if (!GPGPU) {
      ...
      for ( var i = 0, il = birds.length; i < il; i++ ) {
        ...
        // console.log(i, '번째 보이드:', boids[i].position.y);
        // 자연스러운 난수생성? 또는 보이드 생성?
        bird.position.x = boids[i].position.x
        bird.position.y = boids[i].position.y
        bird.position.z = boids[i].position.z
